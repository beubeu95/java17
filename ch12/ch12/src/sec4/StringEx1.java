...
public class StringEx1 {
    public static void main(String[] args) {
        String str1 = new String("KimHyunKyung");
        String str2 ="KimHyunKyung";
        ...
        System.out.println(bArr); // 객체의 주소만 나옴
        //첫번째 방법 : 별도의 메소드를 호출하여 반복문으로 출력
        printArr(bArr);
        System.out.println();
        //두번째 방법 : Arrays.toString(배열명);
        ...
        String data1 =str1.replace("K","G");
        System.out.println("K를 G로 변경 : "+data1);

        String str3 = "    My name is HyunKyung, Kim    ";
