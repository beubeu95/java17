...
//컬렉션 프레임워크(Collection Framework) : 여러 데이터의 모음을 저장할 자료 구조 틀
...
//Stack : 일반적인 데이터, 최신의 데이터를 저장하는 자료구조로 데이터 입출력이 LIFO<LastInFirstOut>로서 거꾸로 진행되는 자료구조임
//Queue : 데이터 입출력이 FIFO<FirstInFirstOut>로서 순서대로 진행되는 자료구조로 CPU 스케줄링->쓰레드의 우선순위 또는 발생순으로 처리
//Deque : FIFO/LIFO 운영방식이 모두 가능한 자료구조

public class ListEx1 {
    public static void main(String[] args) {
        String[] author = {"신승원","김승원","박승원","정승원","이승원","최승원"};
